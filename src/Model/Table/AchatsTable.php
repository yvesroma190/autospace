 ...
 * @method \App\Model\Entity\Achat|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Achat saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
