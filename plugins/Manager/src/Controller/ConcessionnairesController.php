 ...
 *
 * @property \Manager\Model\Table\ConcessionnairesTable $Concessionnaires
 *
 * @method \Manager\Model\Entity\Concessionnaire[]|\Cake\Datasource\ResultSetInterface paginate($object = null, array $settings = [])
 */
