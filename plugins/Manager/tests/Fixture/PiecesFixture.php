...
class PiecesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'typepiece_id' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'typepiece_id' => 'Lorem ipsum dolor sit amet',
                ...
                'created' => '2020-05-21 19:31:07',
                'modified' => '2020-05-21 19:31:07',
            ],
        ];
        parent::init();
    }
