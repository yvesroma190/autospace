...
<!--<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $concessionnaire->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $concessionnaire->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="concessionnaires form content">
            ...
            <fieldset>
                <legend><?= __('Edit Concessionnaire') ?></legend>
                <?php
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div>
                                ...
                                <?= $this->Form->postLink(
                                    __('Supprimer cet concesionnaire'),
                                    ['action' => 'delete', $concessionnaire->id],
                                    ['confirm' => __('Voulez-vous supprimer cet concessionnaire? # {0}?', $concessionnaire->id), 'class' => 'btn btn-outline-danger']
                                ) ?>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <!--<form class="form-horizontal">-->
                                <div class="card-body">
                                    <h4 class="card-title">Modifier un concessionnaire</h4>
                                    <div class="form-group row">
                                        <div class="col-sm-9">
                                        <?= $this->Form->control('name', ['class'=>'form-control', 'type'=>'text', 'name'=>'name', 'label'=>'Nom', 'placeholder'=>'Nom du concessionnaire']); ?>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <div class="col-sm-9">
                                        <?= $this->Form->control('tel', ['class'=>'form-control', 'type'=>'text', 'name'=>'tel', 'label'=>'N° Téléphone fixe', 'placeholder'=>'N° de téléphone fixe']); ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-9">
                                        <?= $this->Form->control('bp', ['class'=>'form-control', 'type'=>'text', 'name'=>'bp', 'label'=>'Boîte postale', 'placeholder'=>'Boîte postale']); ?>
                                        </div>
                                    </div>
