                    ...
                    <div class="col-12">
                        <div class="card">
                            <div>
                                ...
                                <?= $this->Form->postLink(
                                    __('Supprimer cette marque'),
                                    ['action' => 'delete', $marque->id],
                                    ['confirm' => __('Voulez-vous supprimer cette marque? # {0}?', $marque->id), 'class' => 'btn btn-outline-danger']
                                ) ?>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <!--<form class="form-horizontal">-->
                                <div class="card-body">
                                    <h4 class="card-title">Modifier une marque de voitures</h4>
