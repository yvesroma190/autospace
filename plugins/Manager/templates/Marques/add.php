            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div>
                                <?= $this->Html->link(__('Liste des marques de voitures'), ['action' => 'index'], ['class' => 'btn btn-outline-primary']) ?>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <!--<form class="form-horizontal">-->
                                <div class="card-body">
                                    <h4 class="card-title">Ajouter une marque de voitures</h4>
                                    <div class="form-group row">
                                        <!--<label for="fname" class="col-sm-3 text-right control-label col-form-label">Nom</label>-->
                                        <div class="col-sm-9">
                                        <?= $this->Form->control('name', ['class'=>'form-control', 'type'=>'text', 'name'=>'name', 'label'=>'Nom', 'placeholder'=>'Nom de la marque']); ?>
                                        </div>
                                    </div>
                                </div>
