 ...
 * @var \Cake\Datasource\EntityInterface $marque
 */
?>
<!--<div class="row">
    <aside class="column">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div>
                                <a href="<?= $this->Url->build(['controller' => 'Marques', 'action' => 'index']); ?>"><button type="button" class="btn btn-outline-primary">Liste des marques de voitures</button></a>

                                <?= $this->Html->link(__('Modifier'), ['action' => 'edit', $marque->id], ['class' => 'btn btn-outline-success']) ?>
                                <?= $this->Form->postLink(__('Supprimer'), ['action' => 'delete', $marque->id], ['confirm' => __('Voulez-vous supprimer cette catégorie? # {0}?', $marque->id), 'class' => 'btn btn-outline-danger']) ?>
                                <?= $this->Html->link(__('Ajouter une marque'), ['action' => 'add'], ['class' => 'btn btn-outline-info']) ?>
