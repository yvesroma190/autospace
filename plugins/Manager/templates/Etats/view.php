 ...
 * @var \Cake\Datasource\EntityInterface $etat
 */
?>
<!--<div class="row">
    <aside class="column">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">ETATS DE VENTE</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div>
                                <a href="<?= $this->Url->build(['controller' => 'Etats', 'action' => 'index']); ?>"><button type="button" class="btn btn-outline-primary">Liste des états de vente</button></a>

                                <?= $this->Html->link(__('Modifier'), ['action' => 'edit', $etat->id], ['class' => 'btn btn-outline-success']) ?>
                                <?= $this->Form->postLink(__('Supprimer'), ['action' => 'delete', $etat->id], ['confirm' => __('Voulez-vous supprimer cet état? # {0}?', $etat->id), 'class' => 'btn btn-outline-danger']) ?>
                                <?= $this->Html->link(__('Ajouter un état de vente'), ['action' => 'add'], ['class' => 'btn btn-outline-info']) ?>
