 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $etats
 */
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div>
                                <a href="<?= $this->Url->build(['controller' => 'Etats', 'action' => 'add']); ?>"><button type="button" class="btn btn-outline-primary">Ajouter un état de vente</button></a>
                                ...
                                <a href="<?= $this->Url->build(['controller' => 'Categories', 'action' => 'index']); ?>"><button type="button" class="btn btn-outline-dark">Catégories</button></a>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Etats de vente</h5>
                                    <div class="table-responsive">
