                    ...
                    <div class="col-12">
                        <div class="card">
                            <div>
                                ...
                                <?= $this->Form->postLink(
                                    __('Supprimer cet groupe'),
                                    ['action' => 'delete', $usergroup->id],
                                    ['confirm' => __('Voulez-vous supprimer cet groupe? # {0}?', $usergroup->id), 'class' => 'btn btn-outline-danger']
                                ) ?>
                            </div>
                            ...
                            <!--<form class="form-horizontal">-->
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-9">
                                        <?= $this->Form->control('name', ['class'=>'form-control', 'type'=>'text', 'name'=>'name', 'label'=>'Nom', 'placeholder'=>'Nom du groupe']); ?>
                                        </div>
                                    </div>
                                </div>
