 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $carburants
 */
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div>
                                <a href="<?= $this->Url->build(['controller' => 'Carburants', 'action' => 'add']); ?>"><button type="button" class="btn btn-outline-primary">Ajouter un carburant</button></a>
                                ...
                                <a href="<?= $this->Url->build(['controller' => 'Categories', 'action' => 'index']); ?>"><button type="button" class="btn btn-outline-info">Catégories</button></a>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Carburants</h5>
                                    <div class="table-responsive">
