                    ...
                    <div class="col-12">
                        <div class="card">
                            <div>
                                ...
                                <?= $this->Form->postLink(
                                    __('Supprimer cet carburant'),
                                    ['action' => 'delete', $carburant->id],
                                    ['confirm' => __('Voulez-vous supprimer cet carburant? # {0}?', $carburant->id), 'class' => 'btn btn-outline-danger']
                                ) ?>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <!--<form class="form-horizontal">-->
                                <div class="card-body">
                                    <h4 class="card-title">Modifier un carburant</h4>
