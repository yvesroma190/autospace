                        ...
                        <div class="card">
                            <div>
                                ...
                                <?= $this->Form->postLink(
                                    ...
                                    ['action' => 'delete', $client->id],
                                    ['confirm' => __('Voulez-vous supprimer cet client? # {0}?', $client->id), 'class' => 'btn btn-outline-danger']
                                ) ?>
                            </div>
                            ...
                            <!--<form class="form-horizontal">-->
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-9">
                                        <?= $this->Form->control('name', ['class'=>'form-control', 'type'=>'text', 'name'=>'name', 'label'=>'Nom et prénoms']); ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-9">
                                        <?= $this->Form->control('tel', ['class'=>'form-control', 'type'=>'text', 'name'=>'tel', 'label'=>'N° de téléphone fixe']); ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-9">
                                        <?= $this->Form->control('cel', ['class'=>'form-control', 'type'=>'text', 'name'=>'cel', 'label'=>'N° cellulaire']); ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-9">
                                        <?= $this->Form->control('email', ['class'=>'form-control', 'type'=>'text', 'name'=>'email', 'label'=>'Email']); ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-9">
                                        <?= $this->Form->control('adresse', ['class'=>'form-control', 'type'=>'text', 'name'=>'adresse', 'label'=>'Adresse']); ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-9">
