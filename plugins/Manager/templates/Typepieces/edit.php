                    ...
                    <div class="col-12">
                        <div class="card">
                            <div>
                                ...
                                <?= $this->Form->postLink(
                                    __('Supprimer cet type de pièces'),
                                    ['action' => 'delete', $typepiece->id],
                                    ['confirm' => __('Voulez-vous supprimer cet type de pièces? # {0}?', $typepiece->id), 'class' => 'btn btn-outline-danger']
                                ) ?>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <!--<form class="form-horizontal">-->
                                <div class="card-body">
                                    <h4 class="card-title">Modifier un type de pièces</h4>
