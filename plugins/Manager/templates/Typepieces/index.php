 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $typepieces
 */
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div>
                                <a href="<?= $this->Url->build(['controller' => 'Typepieces', 'action' => 'add']); ?>"><button type="button" class="btn btn-outline-primary">Ajouter un type de pièces</button></a>
                                
                                <a href="<?= $this->Url->build(['controller' => 'Pieces', 'action' => 'index']); ?>"><button type="button" class="btn btn-outline-warning">Gestion des pièces détachées</button></a>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Type de pièces</h5>
                                    <div class="table-responsive">
