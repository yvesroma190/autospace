 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $countries
 */
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div>
                                <a href="<?= $this->Url->build(['controller' => 'Countries', 'action' => 'add']); ?>"><button type="button" class="btn btn-outline-primary">Ajouter un pays</button></a>
                                <a href="<?= $this->Url->build(['controller' => 'Villes', 'action' => 'index']); ?>"><button type="button" class="btn btn-outline-success">Gestion des villes</button></a>
                            </div>
