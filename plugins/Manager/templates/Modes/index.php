 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $modes
 */
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div>
                                <a href="<?= $this->Url->build(['controller' => 'Modes', 'action' => 'add']); ?>"><button type="button" class="btn btn-outline-primary">Ajouter un mode d'acquisition</button></a>
                                ...
                                <a href="<?= $this->Url->build(['controller' => 'Categories', 'action' => 'index']); ?>"><button type="button" class="btn btn-outline-warning">Catégories de voitures</button></a>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Modes d'acquisition</h5>
                                    <div class="table-responsive">
