 ...
 * @var \Cake\Datasource\EntityInterface $mode
 */
?>
<!--<div class="row">
    <aside class="column">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">MODES D'ACQUISITION</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div>
                                <a href="<?= $this->Url->build(['controller' => 'Modes', 'action' => 'index']); ?>"><button type="button" class="btn btn-outline-primary">Liste des modes d'acquisition</button></a>

                                <?= $this->Html->link(__('Modifier'), ['action' => 'edit', $mode->id], ['class' => 'btn btn-outline-success']) ?>
                                <?= $this->Form->postLink(__('Supprimer'), ['action' => 'delete', $mode->id], ['confirm' => __('Voulez-vous supprimer cet mode? # {0}?', $mode->id), 'class' => 'btn btn-outline-danger']) ?>
                                <?= $this->Html->link(__('Ajouter un mode'), ['action' => 'add'], ['class' => 'btn btn-outline-info']) ?>
