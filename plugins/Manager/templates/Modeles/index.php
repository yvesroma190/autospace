 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $modeles
 */
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div>
                                <a href="<?= $this->Url->build(['controller' => 'Modeles', 'action' => 'add']); ?>"><button type="button" class="btn btn-outline-primary">Ajouter un modèle de voitures</button></a>
                                
                                <a href="<?= $this->Url->build(['controller' => 'Marques', 'action' => 'index']); ?>"><button type="button" class="btn btn-outline-danger">Marques</button></a>

                                <a href="<?= $this->Url->build(['controller' => 'Categories', 'action' => 'index']); ?>"><button type="button" class="btn btn-outline-success">Catégories</button></a>
