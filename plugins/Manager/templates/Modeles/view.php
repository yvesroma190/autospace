 ...
 * @var \Cake\Datasource\EntityInterface $modele
 */
?>
<!--<div class="row">
    <aside class="column">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">MODELES DE VOITURES</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div>
                                <a href="<?= $this->Url->build(['controller' => 'Modeles', 'action' => 'index']); ?>"><button type="button" class="btn btn-outline-primary">Liste des modèles de voitures</button></a>

                                <?= $this->Html->link(__('Modifier'), ['action' => 'edit', $modele->id], ['class' => 'btn btn-outline-success']) ?>
                                <?= $this->Form->postLink(__('Supprimer'), ['action' => 'delete', $modele->id], ['confirm' => __('Voulez-vous supprimer cette catégorie? # {0}?', $modele->id), 'class' => 'btn btn-outline-danger']) ?>
                                <?= $this->Html->link(__('Ajouter un modèle'), ['action' => 'add'], ['class' => 'btn btn-outline-info']) ?>
