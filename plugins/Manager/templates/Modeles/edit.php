                    ...
                    <div class="col-12">
                        <div class="card">
                            <div>
                                ...
                                <?= $this->Form->postLink(
                                    __('Supprimer cet modèle'),
                                    ['action' => 'delete', $modele->id],
                                    ['confirm' => __('Voulez-vous supprimer cet modèle? # {0}?', $modele->id), 'class' => 'btn btn-outline-danger']
                                ) ?>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <!--<form class="form-horizontal">-->
                                <div class="card-body">
                                    <h4 class="card-title">Modifier un modèle de voitures</h4>
