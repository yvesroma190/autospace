  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container d-flex">
      ...
      <div class="social-links">
        <a href="#" class="twitter"><i class="icofont-user"></i>Connexion</a>
      </div>
    </div>
  </section>
  ...
  <header id="header">
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="index.html"><img src="img/logo.jpg" alt=""></a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="about.html">Trouvez votre voiture</a></li>
          <li><a href="services.html">Cherchez une pièce</a></li>
          <li class="drop-down"><a href="">Nous concernant</a>
            <ul>
