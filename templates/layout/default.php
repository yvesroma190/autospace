...
<title>AUTOSPACE - Véhicules d'occasion en Côte d'Ivoire</title>
...
<!-- <link href="fonts/fontawesome/css/all.min-fonts.css" type="text/css" rel="stylesheet"> -->
	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-xl-2 col-lg-3 col-md-12">
				<a href="http://bootstrap-ecommerce.com/templates.html" class="brand-wrap">
				...
				<form action="#" class="search-header">
					<div class="input-group w-100">
						<select class="custom-select border-right"  name="category_name">
								<option value="">Toutes les catégories</option><option value="codex">4x4 SUV</option>
								<option value="comments">Berline</option>
								<option value="content">Citadine</option>
								<option value="content">Monospace</option>
								<option value="content">Break</option>
								<option value="content">utilitaire</option>
								<option value="content">Grande Berline</option>
								<option value="content">Coupe</option>
								<option value="content">Cabriolet</option>
						</select>
				...
				<div class="widgets-wrap float-md-right">
					<div class="widget-header mr-3">
						<a href="#" class="widget-view">
							...
							<small class="text"> Mon compte </small>
						</a>
					</div>
					<!-- <div class="widget-header mr-3">
						<a href="#" class="widget-view">
					...
					<div class="widget-header">
						<a href="#" class="widget-view">
							...
							<small class="text"> Mon panier </small>
						</a>
					</div>
				</div> <!-- widgets-wrap.// -->
			</div> <!-- col.// -->
...
<div class="row">
	<aside class="col-lg col-md-3 flex-lg-grow-0">
		<nav class="nav-home-aside">
			<h6 class="title-category">NOS OCCASIONS <i class="d-md-none icon fa fa-chevron-down"></i></h6>
...
<div id="carousel1_indicator" class="slider-home-banner carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/banners/slide1.jpg?v=2.0" alt="First slide"> 
    </div>
    <div class="carousel-item">
      <img src="images/banners/slide2.jpg?v=2.0" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img src="images/banners/slide3.jpg?v=2.0" alt="Third slide">
    </div>
  </div>
