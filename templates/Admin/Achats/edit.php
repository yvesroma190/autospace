...
<div id="content-header">
	<div id="breadcrumb"> <a href="#" title="Allez à l'accueil" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="#">Achats</a> <a href="#" class="current">Modifier l'achat</a> </div>
	...
	<div class="contaniner-fluid">
        ...
        <?= $this->Form->postLink(
            __('Supprimer'),
            ['action' => 'delete', $achat->id],
            ['confirm' => __('Voulez-vous supprimer cet achat? # {0}?', $achat->id), 'class' => 'btn btn-danger']
        ) ?>
	</div>
	<hr>
	<div class="row-fluid">
