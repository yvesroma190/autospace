...
<div id="content-header">
	<div id="breadcrumb"> <a href="#" title="Allez à l'accueil" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="#" class="current">Modes</a> </div>
	<h1>Gestion des Modes de vente</h1>
</div>
	<div class="container-fluid">
	<hr>
	<div class="contaniner-fluid">
		<?= $this->Html->link(__('Ajouter un Mode'), ['action' => 'add'], ['class' => 'btn btn-primary']) ?>
	</div>
	<hr>
	<div class="row-fluid">
	  <div class="span12">
			...
			<table class="table table-bordered table-striped">
			  ...
			  <tbody>
                ...
                <tr>
                    ...
                    <td><?= h($mode->modified) ?></td>
                    <td class="actions">
                        <?= $this->Html->link(__('Détails'), ['action' => 'view', $mode->id]) ?>
                        <?= $this->Html->link(__('Modifier'), ['action' => 'edit', $mode->id]) ?>
                        <?= $this->Form->postLink(__('Supprimer'), ['action' => 'delete', $mode->id], ['confirm' => __('Voulez-vous supprimer ce mode? # {0}?', $mode->id)]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
				</tr>
