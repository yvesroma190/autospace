    ...
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $voiture->id), 'class' => 'side-nav-item']
            ) ?>
...
<div id="content-header">
	<div id="breadcrumb"> <a href="#" title="Allez à l'accueil" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="#">Voitures</a> <a href="#" class="current">Modifier la voiture</a> </div>
	...
	<div class="contaniner-fluid">
        ...
        <?= $this->Form->postLink(
            __('Supprimer'),
            ['action' => 'delete', $voiture->id],
            ['confirm' => __('Voulez-vous supprimer cette voiture? # {0}?', $voiture->id), 'class' => 'btn btn-danger']
        ) ?>
	</div>
	<hr>
	<div class="row-fluid">
