...
<div id="content-header">
	<div id="breadcrumb"> <a href="#" title="Allez à l'accueil" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="#">Gallerie de pièces détachées</a> <a href="#" class="current">Modifier l'image</a> </div>
	...
	<div class="contaniner-fluid">
        ...
        <?= $this->Form->postLink(
            __('Supprimer'),
            ['action' => 'delete', $piecegallery->id],
            ['confirm' => __('Voulez-vous supprimer cette image? # {0}?', $piecegallery->id), 'class' => 'btn btn-danger']
        ) ?>
	</div>
	<hr>
	<div class="row-fluid">
