...
<div id="content-header">
	<div id="breadcrumb"> <a href="#" title="Allez à l'accueil" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="#">Marques</a> <a href="#" class="current">Modifier la marque</a> </div>
	...
	<div class="contaniner-fluid">
		...
		<?= $this->Form->postLink(
			__('Supprimer'),
			['action' => 'delete', $marque->id],
			['confirm' => __('Voulez-vous supprimer cette marque? # {0}?', $marque->id), 'class' => 'btn btn-danger']
		) ?>
	</div>
	<hr>
	<div class="row-fluid">
