...
<div id="content-header">
	<div id="breadcrumb"> <a href="#" title="Allez à l'accueil" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="#">Catégories</a><a href="#" class="current">Détails</a> </div>
	<h1>Gestion des Catégories</h1>
</div>
	<div class="container-fluid">
	<hr>
	<div class="contaniner-fluid">
		<?= $this->Html->link(__('Modifier la Catégorie'), ['action' => 'edit', $category->id], ['class' => 'btn btn-success']) ?>
		<?= $this->Form->postLink(__('Supprimer la  Catégorie'), ['action' => 'delete', $category->id], ['confirm' => __('Voulez-vous supprimer cette catégorie? # {0}?', $category->id), 'class' => 'btn btn-danger']) ?>
		<?= $this->Html->link(__('Liste des Catégories'), ['action' => 'index'], ['class' => 'btn btn-info']) ?>
		<?= $this->Html->link(__('Ajouter une Categorie'), ['action' => 'add'], ['class' => 'btn btn-primary']) ?>
	</div>
	<hr>
	<div class="row-fluid">
	  <div class="span12">
