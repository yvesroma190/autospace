...
<div id="content-header">
	<div id="breadcrumb"> <a href="#" title="Allez à l'accueil" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="#">Villes</a> <a href="#" class="current">Modifier la ville</a> </div>
	...
	<div class="contaniner-fluid">
        ...
        <?= $this->Form->postLink(
            __('Supprimer'),
            ['action' => 'delete', $ville->id],
            ['confirm' => __('Voulez-vous supprimer cette ville? # {0}?', $ville->id), 'class' => 'btn btn-danger']
        ) ?>
	</div>
	<hr>
	<div class="row-fluid">
